...
////////////////////////////////////////////////////////////////////////////////
ege2dDisplay::ege2dDisplay(EGEint Width, EGEint Height, EGEint WindowPositionLeft, EGEint WindowPositionTop, std::string Title){
    ...
    //glDepthRange(1.0,50.0);
        ...
        pGC__=new ege3dGraphicContext(Title, this->Width__, this->Height__,WindowPositionLeft,  WindowPositionTop); 
...
//    
      debug("STEP: pLogoTexture->load(EGE_RESOURCES_PATH + EGE2D-Screen-v2.jpg, EGE_ENU_TEXTURE_ROLE::None);") 
      pLogoTexture->load("C:/projects/EGE2D-GUI-master/samples/scadatank/resources/images/scada2.jpg", EGE_ENU_TEXTURE_ROLE::None);    
      debug("STEP: pLogoTexture->loadGpu();   ")     
      pLogoTexture->loadGpu(); 
...
EGEint ege2dDisplay::draw(ege3dTextureAbstract *texture){
    ...
    if(!pGC__->GraphichContextClosing())
    {
        #define EGE_MODE_VAO
            ...
            glUseProgram(pGC__->shaderProgram);
            
            glBindVertexArray(pGC__->vao);
        ...
        //////////////////////////////////
//            glfwMakeContextCurrent(pGC__->window);
//            // wipe the drawing surface clear
//            glClearColor(0.0f,0.2f,0.0f,1.0f);
//            glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
//            glUseProgram(pGC__->shaderProgram);
//            //GLint lPos=glGetAttribLocation(pGC__->shaderProgram,"a_position");
//            //glVertexAttrib3fv(pGC__->vbo,lPos);
//            glBindVertexArray(pGC__->vao);
//            
//            // draw points 0-3 from the currently bound VAO with current in-use shader
//            glDrawArrays(GL_TRIANGLES, 0, 3);
